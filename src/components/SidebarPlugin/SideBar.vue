  ...
  >
    <div class="logo">
      ...
      <span style="color: yellow; font-weight: bolder"
        >Version: {{ getStat.software_version }}</span
      >
    </div>
    <div class="sidebar-wrapper">
      ...
      <md-list class="nav">
        <div class="carousel">
          ...
          <button class="glossy-btn carousel-prev" @click="prevImage">‹</button>
          <button class="glossy-btn carousel-next" @click="nextImage">›</button>
