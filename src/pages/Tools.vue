        ...
        <md-card>
          ...
          <md-card-content>
            <md-bottom-bar @md-changed="tabChange" data-background-color="naghmeh2" >
              ...
              <md-bottom-bar-item md-mini id="tab_wall" data-background-color="naghmeh2" md-label="Wall" md-icon="wallpaper"></md-bottom-bar-item>
            </md-bottom-bar>
          </md-card-content>
...
<script>
import Footage from '../components/Tools/Footage'
...
export default {
  ...
  components: {
    Footage, Snapshot, Services, Wall
  },
  methods: {
    tabChange (v) {
      this.current_tab = v 
